...
<div class="form-container">
    ...
    <input type="text" name="username" required class="appearance-none border rounded w-full py-2 px-20 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><br><br>

    <!-- ช่องกรอก Password -->
    <label for="password" class="block text-gray-700 text-sm font-bold mb-2">รหัสผ่าน:</label>
    <input type="password" name="password" required class="appearance-none border rounded w-full py-2 px-20 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><br><br>

    <!-- ช่องกรอก Email -->
    <label for="email" class="block text-gray-700 text-sm font-bold mb-2">อีเมล:</label>
    <input type="email" name="email" required class="appearance-none border rounded w-full py-2 px-20 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><br><br>

    <!-- ช่องกรอก Name -->
    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">ชื่อ-นาสกุล:</label>
    <input type="text" name="name" required class="appearance-none border rounded w-full py-2 px-20 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><br><br>
    ...
    <div class="center-button">
        <input type="submit" value="สมัครสมาชิก" class="text-white bg-indigo-700 shadow-lg shadow-indigo-700/50 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        
        <!-- ลิงก์สำหรับย้อนกลับไปหน้า login_form.php -->
        <a href="../login/login_form.php" class="text-white bg-indigo-700 shadow-lg shadow-indigo-700/50 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">ย้อนกลับ</a>
    </div>
    </form>
    ...
    async function submitForm() {
        const { value: secret_pass } = await Swal.fire({
